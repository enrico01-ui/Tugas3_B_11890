...
st.markdown("""
        ...
        h1{
            font-familyL 'Courier New', monospace;
            color: #ffffff;    
        }
        h3, p{
...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1890</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'C:\Users\Acer\Downloads\Tugas3_B_11890'
